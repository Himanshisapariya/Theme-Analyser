...
document.addEventListener("DOMContentLoaded", () => {
  ...
  //add aria-hidden="true" and tabindex="-1" to non-visible slides
  ...
  // added tabindex on selected variant
  ...
  // Fallback: set first radio focusable if none selected
  ...
  // const headerSearchSummary = document.querySelector(".header-search-summary");
  // if(headerSearchSummary){
  //   headerSearchSummary.removeAttribute("aria-expanded");
  // }

  // const megamenuArrowDown = document.querySelectorAll(".header-megamenu-toggle-button");

  // const toggleMenu = (arrow, expand) => {
  //   arrow.setAttribute("aria-expanded", String(expand));

  //   const mainMenu = arrow.closest(".list-menu--megamenu");
  //   const menu = mainMenu?.querySelector(".header-mega-menu");
  //   const megamenuWrapper = menu?.querySelector(".header-mega-menu__wrapper");

  //   if (menu) {
  //     menu.style.maxHeight = expand ? "45rem" : "0";
  //     menu.style.opacity = expand ? "1" : "0";
  //     menu.style.visibility = expand ? "visible" : "hidden";
  //   }

  //   if (megamenuWrapper) {
  //     megamenuWrapper.style.opacity = expand ? "1" : "0";
  //     megamenuWrapper.style.visibility = expand ? "visible" : "hidden";
  //   }
  // };

  // if (megamenuArrowDown?.length) {
  //   megamenuArrowDown.forEach(arrow => {
  //     arrow.addEventListener("keydown", e => {
  //       if (e.key === "Enter" || e.key == " ") {
  //         const isExpanded = arrow.getAttribute("aria-expanded") === "true";
  //         toggleMenu(arrow, !isExpanded);
  //       }
  //     });

  //     const megaMenuWrapper = arrow.closest(".header-megamenu-wrapper");
  //     const link = megaMenuWrapper.querySelector("a");

  //     link.addEventListener("mouseenter", () => toggleMenu(arrow, true));
  //     link.addEventListener("mouseleave", () => toggleMenu(arrow, false));

  //     const mainMenu = arrow.closest(".list-menu--megamenu");

  //     if (mainMenu) {
  //       mainMenu.addEventListener("mouseleave", () => toggleMenu(arrow, false));
  //     }
  //   });
  // }
});
...
// document.addEventListener("DOMContentLoaded", function () {
//   // Size chart accordion functionality
//   const sizeChartLink = document.querySelector(".ctm_sizechart_btn a");
//   const accordion = document.getElementById("ctm_size_chart");

//   accordion.scrollIntoView({ behavior: "smooth", block: "center" });

//   const accDescriptions = document.querySelectorAll(".about__accordion-description");
//   accDescriptions.forEach((desc) => {
//     desc.style.display = "none";
//   });

//   const accTitle = document.querySelectorAll(".about__accordion-title");
