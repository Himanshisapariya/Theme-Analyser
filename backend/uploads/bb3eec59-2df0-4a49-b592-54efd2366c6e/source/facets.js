class FacetFiltersForm extends HTMLElement {
	...
	static renderPage(searchParams, event, updateURLHash = true) {
		...
		window.dispatchEvent(new Event("facet-filters-form:rendered"));
	}
...
class PriceRange extends HTMLElement {
	...
	controlSlider() {
		...
		// Single live region for all sliders
		let liveRegion = document.getElementById('price-range-live');
		if (!liveRegion) {
			liveRegion = document.createElement('div');
			liveRegion.id = 'price-range-live';
		...
		inputRangeWrappers.forEach((inputWrapper, index) => {
			...
			inputRangeFrom.oninput = () => {
				...
				// Constrain max thumb's lower bound
				inputRangeTo.setAttribute('aria-valuemin', inputRangeFrom.value);

				// Announce current range to screen readers
				liveRegion.textContent = `Price range: ${inputRangeFrom.value} to ${inputRangeTo.value}`;
			...
			inputRangeTo.oninput = () => {
				...
				// Constrain min thumb's upper bound
				inputRangeFrom.setAttribute('aria-valuemax', inputRangeTo.value);
